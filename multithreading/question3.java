...
public class question3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Runnable r1 = new Runnable() {
            public void run() {
                for(int i = 0; i < numbers.size() / 3; i++) {
                    System.out.println("Thread 1 is currently comparing with: " + numbers.get(i) + " and the max for this thread is: "+ max1[0]);
        ...
        Runnable r2 = new Runnable() {
            public void run() {
                for(int i = numbers.size() / 3; i < 2 * numbers.size() / 3; i++) {
                    System.out.println("Thread 2 is currently comparing with: " + numbers.get(i) + " and the max for this thread is: "+ max2[0]);
        ...
        for(int i = 2 * numbers.size() / 3; i < numbers.size(); i++) {
            System.out.println("Main Thread is currently comparing with: " + numbers.get(i) + " and the max for this thread is: "+ max);
